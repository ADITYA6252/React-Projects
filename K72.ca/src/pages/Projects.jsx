...
import ProjectsCard from '../componenets/projects/ProjectsCard'
  ...
  return (
   <div className='p-4'>
     <div className=' pt-[45vh]'>
      <h2 className='font-[font2] text-[12vw] uppercase text-black '>Projets</h2>
      
    </div>
    <div className='-mt-10 lol'>
   {projects.map(function(elem, idx){
    return <div key={idx} className=' hero w-full  h-[550px] mb-4 flex gap-4'>
